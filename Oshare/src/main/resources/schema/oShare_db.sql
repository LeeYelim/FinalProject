...
delete from board where product_name='비타퓨어 연수기'
delete from board where product_name='충전예초기';
delete from board where product_name='신형 750W전동드릴';
delete from board where product_name='독일 주방기기 명가 BSW 직화 오븐기';
delete from board where product_name='[보쉬] 수공구세트(108pcs)';
delete from board where product_name='스마토 렌치 셋트';
delete from board where product_name='[쉐어링]포맘스 스마트 바운서';
-----------------------------------------------------------------------------------------------------------
SELECT * FROM TAB;
