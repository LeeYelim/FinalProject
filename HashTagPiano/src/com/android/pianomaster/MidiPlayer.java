...
public class MidiPlayer extends LinearLayout {
    ...
    public static void LoadImages(Context context) {
        ...
        rewindImage = BitmapFactory.decodeResource(res, R.drawable.backward);
        ...
        fastFwdImage = BitmapFactory.decodeResource(res, R.drawable.forward);
    ...
    void CreateButtons() {
        ...
        rewindButton.setBackgroundColor(Color.WHITE);
        ...
        fastFwdButton.setBackgroundColor(Color.WHITE);
        ...
        speedText.setTypeface(Typeface.createFromAsset
        		(activity.getAssets(), "dxfont.ttf"));
        speedText.setText("   속도 : 100%   ");
        ...
        speedBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar bar, int progress, boolean fromUser) {
                speedText.setText("   속도 : " + String.format(Locale.US, "%03d", progress) + "%   ");
            }
   ...
   /* public void SetPiano(Piano p) {
    ...
    public void SetPiano(PianoFragment p) {
        piano = p;
    }
